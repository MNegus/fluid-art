...
![The various stages of refinement](koch/f.gif)
...
set yr [100:100000]
set logscale y
set xlabel 'refinement iteration' font "Helvetica,15" 
set ylabel 'Grid cells on the curve' font "Helvetica,15"
set key font "Helvetica,15" box top left width 6 height 1.5 spacing 1.5
set tics font "Helvetica,15"
plot "cells.dat" pt 3 title "Number of cells on the curve"  ,\
      (2**(1.26*x))*200 lw 3 title "2^{1.26x} "
~~~
